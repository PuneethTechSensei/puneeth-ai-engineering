...
const lessonSpecs = [
  {
    ...
    "why": "A project can work on one laptop and fail on another because runtime and dependency assumptions are hidden.",
    "body": "Separate the Python interpreter, virtual environment, package manager and dependency record; understand why version pinning and a clean environment make a project reproducible.",
    "example": "Worked example: Create a small project, record the Python version, create .venv, install one dependency, record it, delete the environment, recreate it and run the same program.",
    "takeaways": [
      "Separate the Python interpreter, virtual environment, package manager and dependency record; understand why version pinning and a clean environment make a project reproducible.",
      "Practice: Create a small project, record the Python version, create .venv, install one dependency, record it, delete the environment, recreate it and run the same program.",
      "Failure to diagnose: Install an incompatible dependency version or run outside the virtual environment; capture the error and identify which assumption changed.",
      "Proof: A clean-clone checklist plus terminal output showing the same program running in a recreated environment."
    ],
    "code": "python --version\npython -m venv .venv\npython -m pip install requests\npython -m pip freeze",
    "practice": "Create a small project, record the Python version, create .venv, install one dependency, record it, delete the environment, recreate it and run the same program.",
    "breakIt": "Install an incompatible dependency version or run outside the virtual environment; capture the error and identify which assumption changed.",
    "proof": "A clean-clone checklist plus terminal output showing the same program running in a recreated environment.",
    ...
    "experience": {
      "type": "Experiment",
      "title": "Python runtime & package management — applied lab",
      "task": "Create a small project, record the Python version, create .venv, install one dependency, record it, delete the environment, recreate it and run the same program.",
      "evidence": "A clean-clone checklist plus terminal output showing the same program running in a recreated environment.",
      "breakIt": "Install an incompatible dependency version or run outside the virtual environment; capture the error and identify which assumption changed.",
    ...
    "competency": {
      "difficulty": "Core",
      "time": "30–45 min",
      "artifact": "A clean-clone checklist plus terminal output showing the same program running in a recreated environment.",
      "prerequisites": [],
      "success": [
      ...
      "failureMode": "Install an incompatible dependency version or run outside the virtual environment; capture the error and identify which assumption changed.",
      "reviewed": "2026-09-21",
      "freshness": null,
      "editorial": "V9 — multi-level editorial pass"
    },
    "skillTarget": "Create an isolated Python environment, record dependencies, and reproduce the same program from a clean environment.",
    ...
    "decision": "Which Python/dependency specification is sufficient for another engineer to recreate the environment?"
  },
  {
    "id": "00-2",
    "phase": "00",
    ...
    "why": "AI projects change quickly; without recoverable history, an experiment can destroy a working system.",
    "body": "Build the Git mental model: working tree → staging area → commit, then branch → experiment → merge/revert.",
    "example": "Worked example: Make a tiny Python project, commit a known-good state, create a branch, make a change, inspect diff/log, then merge it.",
    "takeaways": [
      "Build the Git mental model: working tree → staging area → commit, then branch → experiment → merge/revert.",
      "Practice: Make a tiny Python project, commit a known-good state, create a branch, make a change, inspect diff/log, then merge it.",
      "Failure to diagnose: Introduce a deliberate bug on the branch and recover the known-good state without deleting the experiment.",
      "Proof: A short Git history with a feature branch, one recovered failure and commands explaining how you recovered it."
    ],
    "code": "git status\ngit switch -c experiment\ngit diff\ngit add .\ngit commit -m \"experiment\"\ngit log --oneline --graph --all",
    "practice": "Make a tiny Python project, commit a known-good state, create a branch, make a change, inspect diff/log, then merge it.",
    "breakIt": "Introduce a deliberate bug on the branch and recover the known-good state without deleting the experiment.",
    "proof": "A short Git history with a feature branch, one recovered failure and commands explaining how you recovered it.",
    "transfer": "This becomes the operating discipline for every later project: reproducible environments, inspectable changes, safe configuration and recoverable work.",
    "mistakes": [
      "Assuming a command succeeded because it produced no obvious error.",
    ...
    "experience": {
      "type": "Debug",
      "title": "Git fundamentals & branching — applied lab",
      "task": "Make a tiny Python project, commit a known-good state, create a branch, make a change, inspect diff/log, then merge it.",
      "evidence": "A short Git history with a feature branch, one recovered failure and commands explaining how you recovered it.",
      "breakIt": "Introduce a deliberate bug on the branch and recover the known-good state without deleting the experiment.",
      "transfer": "These habits make every later experiment reproducible and debuggable."
    },
    "competency": {
      "difficulty": "Core",
      "time": "30–45 min",
      "artifact": "A short Git history with a feature branch, one recovered failure and commands explaining how you recovered it.",
      "prerequisites": [],
      "success": [
        "The explanation matches the observed mechanism or system behavior.",
        "The hands-on task produces the expected artifact, output or measurement.",
      ...
      "failureMode": "Introduce a deliberate bug on the branch and recover the known-good state without deleting the experiment.",
      "reviewed": "2026-09-21",
      "freshness": null,
      "editorial": "V9 — multi-level editorial pass"
    },
    "skillTarget": "Use commits and branches to make an experiment recoverable, inspect exactly what changed, and restore a known-good state.",
    "usedLater": "This becomes the operating discipline for every later project: reproducible environments, inspectable changes, safe configuration and recoverable work.",
    "guidedSteps": [
      "State the engineering problem and the expected result before changing the project.",
      "Run the smallest example that exposes the relevant contract.",
    ...
    "decision": "Which change should be isolated, committed or reverted so the working state remains recoverable?"
  },
  {
    "id": "00-3",
    "phase": "00",
    ...
    "why": "AI engineering tools are often driven from terminals, scripts and file paths; weak shell skills turn simple failures into guesswork.",
    "body": "Learn paths, working directories, file inspection, exit codes, pipes and safe command composition on the OS you use.",
    "example": "Worked example: Navigate to a project, locate a configuration file, inspect it without opening an editor, run a script and capture its exit code/output.",
    "takeaways": [
      "Learn paths, working directories, file inspection, exit codes, pipes and safe command composition on the OS you use.",
      "Practice: Navigate to a project, locate a configuration file, inspect it without opening an editor, run a script and capture its exit code/output.",
      "Failure to diagnose: Run the command from the wrong directory or against a missing file and diagnose the path problem from the error alone.",
      "Proof: A reproducible terminal transcript that shows navigation, inspection, execution and recovery."
    ],
    "code": "python -c \"from pathlib import Path; print(Path.cwd()); print([p.name for p in Path(\".\").iterdir()])\"",
    "practice": "Navigate to a project, locate a configuration file, inspect it without opening an editor, run a script and capture its exit code/output.",
    "breakIt": "Run the command from the wrong directory or against a missing file and diagnose the path problem from the error alone.",
    "proof": "A reproducible terminal transcript that shows navigation, inspection, execution and recovery.",
    "transfer": "This becomes the operating discipline for every later project: reproducible environments, inspectable changes, safe configuration and recoverable work.",
    "mistakes": [
      "Assuming a command succeeded because it produced no obvious error.",
    ...
    "experience": {
      "type": "Build",
      "title": "Command-line & filesystem skills — applied lab",
      "task": "Navigate to a project, locate a configuration file, inspect it without opening an editor, run a script and capture its exit code/output.",
      "evidence": "A reproducible terminal transcript that shows navigation, inspection, execution and recovery.",
      "breakIt": "Run the command from the wrong directory or against a missing file and diagnose the path problem from the error alone.",
      "transfer": "These habits make every later experiment reproducible and debuggable."
    },
    "competency": {
      "difficulty": "Core+",
      "time": "30–45 min",
      "artifact": "A reproducible terminal transcript that shows navigation, inspection, execution and recovery.",
      "prerequisites": [],
      "success": [
        "The explanation matches the observed mechanism or system behavior.",
        "The hands-on task produces the expected artifact, output or measurement.",
      ...
      "failureMode": "Run the command from the wrong directory or against a missing file and diagnose the path problem from the error alone.",
      "reviewed": "2026-09-21",
      "freshness": null,
      "editorial": "V9 — multi-level editorial pass"
    },
    "skillTarget": "Navigate, inspect, create, move, search and safely manipulate project files from a shell without guessing where data lives.",
    "usedLater": "This becomes the operating discipline for every later project: reproducible environments, inspectable changes, safe configuration and recoverable work.",
    "guidedSteps": [
      "State the engineering problem and the expected result before changing the project.",
      "Run the smallest example that exposes the relevant contract.",
    ...
    "decision": "What engineering choice does command-line & filesystem skills require, and what evidence would justify that choice?"
  },
  {
    "id": "00-4",
    "phase": "00",
